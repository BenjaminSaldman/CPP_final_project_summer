...
אם השחקן נחת בכל משבצת שהיא לא "לך לכלא" או "חניה חופשית" השחקן יכול לבנות בתים בנכסים שלו לפי חוקי המשחק ולבצע עסקאות עם שחקנים אחרים (כלומר להחליף כסף או נכסים תמורת כסף או נכסים).
